...
**[🇺🇸 English](README.md)** | **[🇨🇳 中文](README.zh-CN.md)** | **[🇹🇼 繁體中文](README.zh-TW.md)** | **🇯🇵 日本語**
...
curl -o ~/.codex/skills/pua-ja/SKILL.md \
  https://raw.githubusercontent.com/yicianwang0629/pua/main/codex/pua-ja/SKILL.md
...
curl -o .cursor/rules/pua-ja.mdc \
  https://raw.githubusercontent.com/yicianwang0629/pua/main/cursor/rules/pua-ja.mdc
```
...
curl -o .kiro/steering/pua-ja.md \
  https://raw.githubusercontent.com/yicianwang0629/pua/main/kiro/steering/pua-ja.md
```
...
curl -o .kiro/skills/pua-ja/SKILL.md \
  https://raw.githubusercontent.com/yicianwang0629/pua/main/skills/pua-ja/SKILL.md
```
...
curl -o .claude/agents/pua-enforcer.md \
  https://raw.githubusercontent.com/yicianwang0629/pua/main/agents/pua-enforcer-ja.md
```
